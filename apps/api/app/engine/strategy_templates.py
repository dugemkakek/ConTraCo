...
STRATEGY_TEMPLATES: dict[str, dict[str, Any]] = {
    "smc_scalper": {
        ...
        "timeframes": ["1m", "5m"],
        "gates": ["market_structure_smc", "volume_momentum", "market_regime", "risk_tradeability"],
        "gate_weights": {
            "market_structure_smc": 0.3, "volume_momentum": 0.3,
    ...
    "momentum_breakout": {
        ...
        "gates": ["volume_momentum", "market_structure", "classical_ta",
                  "market_structure_smc", "risk_tradeability"],
        "score_threshold": 0.7,
        "default_rr": 2.0,
    },
    "mean_reversion": {
